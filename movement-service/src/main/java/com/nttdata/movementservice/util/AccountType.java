...
import static com.nttdata.movementservice.util.AppConstant.CHECKING_MIN_OPENING_AMOUNT;
...
import static com.nttdata.movementservice.util.AppConstant.CHECKING_PYME_MIN_OPENING_AMOUNT;
...
import static com.nttdata.movementservice.util.AppConstant.SAVING_MIN_OPENING_AMOUNT;
...
import static com.nttdata.movementservice.util.AppConstant.SAVING_VIP_MIN_OPENING_AMOUNT;
...
public enum AccountType {
    SAVING(SAVING_ACCOUNT_MAINTENANCE, SAVING_ACCOUNT_MAX_MONTH_MOV,
            SAVING_MIN_OPENING_AMOUNT, SAVING_MOVEMENT_COMMISSION),    // Ahorro
    SAVING_VIP(SAVING_VIP_ACCOUNT_MAINTENANCE, SAVING_VIP_ACCOUNT_MAX_MONTH_MOV,
            SAVING_VIP_MIN_OPENING_AMOUNT, SAVING_VIP_MOVEMENT_COMMISSION),    // Ahorro VIP
    CHECKING(CHECKING_ACCOUNT_MAINTENANCE, CHECKING_ACCOUNT_MAX_MONTH_MOV,
            CHECKING_MIN_OPENING_AMOUNT, CHECKING_MOVEMENT_COMMISSION),   // Cuenta corriente
    CHECKING_PYME(CHECKING_PYME_ACCOUNT_MAINTENANCE, CHECKING_PYME_ACCOUNT_MAX_MONTH_MOV,
            CHECKING_PYME_MIN_OPENING_AMOUNT, CHECKING_PYME_MOVEMENT_COMMISSION),   // Cuenta corriente MYPE
