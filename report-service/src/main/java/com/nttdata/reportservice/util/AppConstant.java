...
public class AppConstant {
    ...
    public static final String ACCOUNTS_WITH_MOVEMENTS_BY_CUSTOMER_URI = "http://localhost:8083/api/v1/customers/{customerId}/accounts/with-movements";
    public static final String CREDITS_BY_CUSTOMER_URI = "http://localhost:8084/api/v1/customers/{customerId}/credits";
    public static final String CREDITS_WITH_MOVEMENTS_BY_CUSTOMER_URI = "http://localhost:8084/api/v1/customers/{customerId}/credits/with-movements";
